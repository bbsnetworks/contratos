...
<body class="min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-6 md:px-6 lg:px-8">
        ...
        <form id="formContratoFibra" class="space-y-6">
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="apellidoPaterno" class="input-dark requerido"
                            placeholder="Apellido paterno">
                    </div>

                    <div>
                        <label class="label-main">Apellido materno *</label>
                        <input type="text" id="apellidoMaterno" class="input-dark requerido"
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-4">
                        ...
                        <input type="text" id="calle" class="input-dark requerido" placeholder="Calle">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="numeroInterior" class="input-dark" placeholder="Interior">
                    </div>

                    <div class="md:col-span-4">
                        <label class="label-main">Colonia *</label>
                        <input type="text" id="colonia" class="input-dark requerido" placeholder="Colonia">
                    </div>

                    <div class="md:col-span-4">
                        <label class="label-main">Alcaldía / Municipio *</label>
                        <input type="text" id="municipio" class="input-dark requerido" placeholder="Municipio">
                    </div>

                    <div class="md:col-span-3">
                        <label class="label-main">Estado *</label>
                        <input type="text" id="estado" class="input-dark requerido" placeholder="Estado">
                    </div>

                    <div class="md:col-span-2">
                        <label class="label-main">C.P. *</label>
                        <input type="text" id="cp" class="input-dark requerido" placeholder="C.P.">
                    </div>
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                    ...
                    <div>
                        ...
                        <input type="text" id="telefono" class="input-dark requerido" placeholder="Teléfono">
                    </div>
                </div>
            </section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-5">
                        ...
                        <select id="descripcionPaquete" class="select-dark requerido">
                            ...
                            <!-- Fibra -->
                            <option value="BBS Fiber 30" data-precio="300">BBS Fiber 30</option>
                            <option value="BBS Fiber 50" data-precio="400">BBS Fiber 50</option>
                            <option value="BBS Fiber 80" data-precio="500">BBS Fiber 80</option>

                            <!-- Antena -->
                            <option value="Residencial 7 MB/s" data-precio="250">Residencial 7 MB/s</option>
                            <option value="Residencial 10 MB/s" data-precio="300">Residencial 10 MB/s</option>
                            <option value="Residencial 15 MB/s" data-precio="350">Residencial 15 MB/s</option>
                            <option value="Residencial 20 MB/s" data-precio="400">Residencial 20 MB/s</option>
                            <option value="Residencial 30 MB/s" data-precio="450">Residencial 30 MB/s</option>
                            <option value="Residencial 40 MB/s" data-precio="500">Residencial 40 MB/s</option>
                            <option value="Residencial 50 MB/s" data-precio="600">Residencial 50 MB/s</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-6" data-radio-group="aplicaReconexcion">
                        ...
                        <div class="flex flex-wrap gap-6 mt-2">
                            <label class="radio-line">
                                <input type="radio" name="aplicaReconexcion" value="si"
                                    class="mini-check requerido-radio">
                                <span>Sí</span>
                            </label>
                            <label class="radio-line">
                                <input type="radio" name="aplicaReconexcion" value="no"
                                    class="mini-check requerido-radio">
                                <span>No</span>
                            </label>
                        </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <input type="number" id="mesesPlazo" class="input-dark" placeholder="Meses">
                    </div>
                ...
                <div class="glass-card rounded-3xl p-5 md:p-6">
                    ...
                    <div class="space-y-4">
                        <div data-radio-group="tipoEntregaEquipo">
                            ...
                            <div class="flex flex-wrap gap-6 mt-2">
                                <label class="radio-line">
                                    <input type="radio" name="tipoEntregaEquipo" value="comodato"
                                        class="mini-check requerido-radio">
                                    <span>Comodato</span>
                                </label>
                                <label class="radio-line">
                                    <input type="radio" name="tipoEntregaEquipo" value="compraventa"
                                        class="mini-check requerido-radio">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div data-radio-group="modalidadPagoEquipo">
                                ...
                                <div class="flex flex-wrap gap-6 mt-2">
                                    <label class="radio-line">
                                        <input type="radio" name="modalidadPagoEquipo" value="unico" class="mini-check">
                                        <span>Pago único</span>
                                    </label>
                                    <label class="radio-line">
                                        <input type="radio" name="modalidadPagoEquipo" value="diferido"
                                            class="mini-check">
                                        <span>Diferido</span>
                                    </label>
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="costoDiferido" class="input-dark" placeholder="$0.00">
                            </div>

                            <div>
                                <label class="label-main">Meses diferido</label>
                                <input type="number" id="mesesDiferido" class="input-dark" placeholder="Meses">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card rounded-3xl p-5 md:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="domicilioInstalacion" class="input-dark requerido"
                                placeholder="Domicilio de instalación">
                        </div>

                        <div>
                            <label class="label-main">Fecha *</label>
                            <input type="date" id="fechaInstalacion" class="input-dark requerido">
                        </div>

                        <div>
                            <label class="label-main">Hora *</label>
                            <input type="time" id="horaInstalacion" class="input-dark requerido">
                        </div>
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label class="chk-line"><input type="checkbox" id="mpEfectivo" class="mini-check">
                            <span>Efectivo</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpTransferencia" class="mini-check">
                            <span>Transferencia bancaria</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpDeposito" class="mini-check">
                            <span>Depósito a cuenta bancaria</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpTiendasServicios" class="mini-check">
                            <span>Pago en tiendas de servicios</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpTarjeta" class="mini-check"> <span>Tarjeta
                                de crédito o débito</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpDomiciliado" class="mini-check">
                            <span>Domiciliado con tarjeta</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpEnLinea" class="mini-check"> <span>Pago en
                                línea</span></label>
                        <label class="chk-line"><input type="checkbox" id="mpCentrosServicio" class="mini-check">
                            <span>Pago en tiendas o centros de servicio</span></label>
                    </div>
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="mesesCargoTarjeta" class="input-dark" placeholder="Meses">
                    </div>
                </div>
            </section>
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="banco" class="input-dark" placeholder="Nombre del banco">
                    </div>
            ...
            <section class="glass-card rounded-3xl p-5 md:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="diaFirma" class="input-dark requerido" placeholder="Día">
                    </div>

                    <div>
                        <label class="label-main">Mes *</label>
                        <input type="text" id="mesFirma" class="input-dark requerido" placeholder="Mes">
                    </div>

                    <div>
                        <label class="label-main">Año *</label>
                        <input type="text" id="anioFirma" class="input-dark requerido" placeholder="Año">
                    </div>
                </div>
            </section>
            <!-- Firma -->
...
<section class="glass-card rounded-3xl p-5 md:p-6">
    <div class="section-title rounded-2xl px-4 py-3 mb-5">
        ...
        <p class="text-sm text-slate-300">Firma en el recuadro o abre la vista completa para firmar más cómodo.</p>
    </div>
